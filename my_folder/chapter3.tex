...
\input{my_folder/chapter3_indirect.tex} % Неявная отрисовка
\input{my_folder/chapter3_common_structure.tex} % Общая структура
\input{my_folder/chapter3_prepass.tex} % Prepass	
