...
\newcommand{\SupervisorJob}{\textcolor{red}{доцент ВШПМиВФ}} %
\newcommand{\SupervisorJobVin}{\textcolor{red}{доцент ВШПМиВФ}} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\SupervisorDegree}{\textcolor{red}{степень}} %
\newcommand{\SupervisorTitle}{\textcolor{red}{звание}} % 
%%
%%
...
%%% НЕ НАШЁЛ ГДЕ ЭТО НУЖНО
\newcommand{\HeadAp}{\textcolor{blue}{И.О.\,Фамилия}} % И. О. Фамилия руководителя подразделения (руководителя ОП)
...
\newcommand{\ConsultantExtraDegree}{старший преподаватель, ВШПМиВФ} % 
...
%%
%%
\renewcommand{\thesisTitle}{Оптимизация количества вызовов отрисовки в современных графических системах}
\newcommand{\thesisDegree}{работа бакалавра}% дипломный проект, дипломная работа, магистерская диссертация %c 2020
\newcommand{\thesisTitleEn}{Optimizing the number of draw calls on modern graphics systems} %2020
\newcommand{\thesisDeadline}{26.06.2023}
\newcommand{\thesisStartDate}{07.02.2023}
\newcommand{\thesisYear}{2023}
%%
%%
\newcommand{\group}{5030102/90201} % заменить вместо N номер группы
...
%%
%%
\newcommand{\keywordsRu}{\textcolor{red}{Стилевое оформление сайта, управление контентом, php, MySQL, архитектура системы}} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{\textcolor{red}{Style registration, content management, php, MySQL, system architecture}} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
...
\newcommand{\abstractRu}{Данная работа посвящена разработке и реализации архитектуры конвейера отрисовки, снижающей нагрузку на центральный процессор, тем самым увеличивая объем доступных для разработчика ресурсов компьютера\newline.
В качестве основной демонстрационной сцены используется совокупность различных трехмерных геометрических объектов, освещённых при помощи модели, основанной на физической модели микрограней. Весь исходный код проекта написан на языке C++ с применением графической библиотеки DirectX 12. Средством для программирования шейдеров является HLSL.\newline
Наиболее значимым результатом является разработка гибридного алгортма отрисовки прозрачных объектов, который не требует их упорядочивания. В результате использования описанного алгоритма и предлагаемой архитуры была написана система для вывода графических объектов, количество отрисовок в которой не зависит от числа выводимых объектов.\newline
Предложенная архитектура пригодна для применения в современных графических приложениях и может быть развита в дальнейшем для получения более производительных результатов.} % ВВЕДИТЕ текст аннотации по-русски
%%
%%
